...
class Cctv extends CI_Controller
{
	...
	{
		$sql = "SELECT *, cctv_sta-accident_sta AS jarak, TIMESTAMPDIFF(HOUR, event_time, NOW()) 
				...
				AND cctv_sta-accident_sta BETWEEN -800 AND 800
				AND TIMESTAMPDIFF(HOUR, event_time, NOW()) BETWEEN 0 AND 3";
