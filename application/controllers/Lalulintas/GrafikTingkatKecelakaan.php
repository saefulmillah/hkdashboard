 ...
 * 
 */
class GrafikTingkatKecelakaan extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = array(
			...
			'breadcrumb' => 'Lalu Lintas > Grafik Lalu Lintas'
		);

		$layout = array('header' => $this->load->view('layout/_header',  $data, TRUE),
						'style'  => $this->load->view('lalulintas/grafiktingkatkecelakaan/style', '', TRUE),
						'menu' => $this->load->view('layout/_menu', $data, TRUE),
						'index'  => $this->load->view('lalulintas/grafiktingkatkecelakaan/index', '', TRUE),
						'js' => $this->load->view('lalulintas/grafiktingkatkecelakaan/js', '', TRUE), 
