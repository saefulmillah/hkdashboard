 ...
 * 
 */
class KejadianKhusus extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('KejadianKhusus_model', 'KejadianKhusus');
	...
	public function index()
	{
		...
		$layout = array('header' => $this->load->view('layout/_header',  $data, TRUE),
						'style'  => $this->load->view('transaction/kejadiankhusus/style', '', TRUE),
						'menu' => $this->load->view('layout/_menu', $data, TRUE),
						'index'  => $this->load->view('transaction/kejadiankhusus/index', '', TRUE),
						'js' => $this->load->view('transaction/kejadiankhusus/js', '', TRUE), 
	...
	public function getKejadianKhusus()
	{
		$list = $this->KejadianKhusus->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->KejadianKhusus->count_all(),
                        "recordsFiltered" => $this->KejadianKhusus->count_filtered(),
                        "data" => $data,
                );
