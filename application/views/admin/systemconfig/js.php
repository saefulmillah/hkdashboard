...
var handle_datatables = function () {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Admin/SystemConfig/getSystemConfig')?>",
            "type": "POST",
            "data": function ( data ) {
...
var handle_save = function () {
    var str_url = "<?php echo site_url('Admin/SystemConfig/save')?>";
    $.ajax({
        type: "POST",
        url: str_url,
        dataType: "json",
...
var handle_main = function () {
    main = "<?=site_url('Admin/SystemConfig/main')?>"
...
var handle_new = function () {
    main = "<?=site_url('Admin/SystemConfig/add')?>"
    $('#content-ajax').load(main, function () {
        handle_datepicker();
    })
}
