	...
	<div class="row">
		<div class="col-md-12 body-dashboard">
			<div class="col-md-8 chart-container">
				<div>
					<div id="progress1">
						<div class="font-roboto" style="font-size: 2rem; font-weight: bold; color:#FF0700; position: absolute; top: 84px; left: 28px; line-height: 1rem;">75<span style="font-size: 0.9rem;">%</span><br><span style="font-size: 0.7rem;">Accident</span></div>
					</div>
					<!-- <div id="progress2" >
					...
					<div id="progress3" style="background-color: #003366; z-index: -1;" class="rounded-circle">
						<div class="font-roboto" style="font-size: 2rem; font-weight: bold; color:#ffb900; position: absolute; top: 94px; left: 115px; line-height: 1rem;">50<span style="font-size: 0.9rem;">%</span><br><span style="font-size: 0.7rem;">Potholes</span></div>
					</div>
					...
					<img src="<?=base_url('assets/images/gear16.png')?>" width="500" id="gear1">
					<img src="<?=base_url('assets/images/gear16.png')?>" width="500" id="gear2">
				...
				<div class="card border border-primary bg-dark-blue2">
				  ...
				  <div class="card-body text-white">
				  	<div class="d-flex justify-content-between">
				  		<div class="p-2">Total Lalin</div>
				  		<div class="p-2">3.097.878</div>
				  	</div>
				  	<div class="progress" style="height: 0.6rem;">
					  <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
					</div>
					<div class="d-flex justify-content-between">
				  		<div class="p-2">Total Pendapatan</div>
				  		<div class="p-2">Rp. 318.595.839.963</div>
				  	</div>
				  	<div class="progress" style="height: 0.6rem;">
