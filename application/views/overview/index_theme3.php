	...
	<div class="row">
		<div class="col-md-12 body-dashboard">
				...
				<div class="col-md-4 chart-container" style="position: absolute;right:0px; top: 61px;">	
					<div class="card border border-blue border-info" style="background-color: rgba(0, 0, 0, 1);">
					...
					<div class="card border border-blue border-info" style="background-color: rgba(0, 0, 0, 1); margin-top: 0.5rem;">
					...
					<div class="card border border-blue border-info shadow shadow-blue" style="margin-top: 0.5rem; height: 220px;" id="ATPmap">
					</div>
				</div>
   		   	</div>						
		</div>
