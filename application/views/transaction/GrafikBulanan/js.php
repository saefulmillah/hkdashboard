...
var handle_search = function () {
    var str_url = "<?=site_url('Transaction/GrafikBulanan/getDataBulanan')?>";
    // $("#search").on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                // console.log(data);
                handle_grafik24Jam(data);
            }
        });
    // })
}
var handle_grafik24Jam = function (data) {
    // Build the chart
    ...
    $('#GrafikBulanan').highcharts({
        ...
        title: {
            text: 'Lalin dan Pendapatan - 2018'
        },
        xAxis: [{
