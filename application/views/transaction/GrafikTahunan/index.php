<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<span class="d-block">
				<form class="form-inline" action="<?=site_url('Transaction/GrafikTahunan/getExcel')?>" id="myForm" name="myForm" method="POST" target="_BLANK">
		...
		<div class="col-md-12 chart-container" id="GrafikTahunan">
	    </div>	
	</div>
</div>
